...
import type { NotificationQueryParams } from '../../types/bcm.types'
import type {
  Notification,
  NotificationCounts,
...
export class NotificationService extends BaseService {
   ...
   */
  async getMyNotifications(): Promise<PaginatedResponse<Notification>> {
    return this.getPaginated<Notification>(API_ENDPOINTS.NOTIFICATIONS.MY)
  }
