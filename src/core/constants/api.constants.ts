...
export const API_ENDPOINTS = {
  ...
  AUTH_TOKENS: {
    ...
    REVOKE_ALL: (userId: string) => `/auth/tokens/users/${userId}/revoke-all`,
    BY_USER: (userId: string) => `/auth/tokens/users/${userId}`,
    ...
    BY_VALUE: (tokenValue: string) => `/auth/tokens/value/${tokenValue}`,
  ...
  USERS: {
    ...
    STATISTICS: '/users/users/statistics',
    ...
    UPDATE: (uuid: string) => `/users/users/${uuid}`,
    CHANGE_PASSWORD: (uuid: string) => `/users/users/${uuid}/change-password`,
