...
export const API_ENDPOINTS = {
  ...
  BUSINESS_UNITS: {
    ...
    BY_HEAD_USER: (headUserId: string) => `/business-units/head/${headUserId}`,
    BY_CRITICALITY: (criticalityScore: string) => `/business-units/criticality/${criticalityScore}`,
  ...
  DEPARTMENTS: {
    ...
    TREE: (businessUnitId: string) => `/departments/tree/${businessUnitId}`,
    SUB_DEPARTMENTS: (parentDepartmentId: string) => `/departments/sub/${parentDepartmentId}`,
  ...
  RISKS: {
    ...
    CONTROLS: (uuid: string) => `/risks/${uuid}/controls`,
    CONTROL: (uuid: string, controlId: string) => `/risks/${uuid}/controls/${controlId}`,
    ORGANISATION_MATRIX: (organisationId: string) => `/risks/organisation/${organisationId}/matrix`,
    ORGANISATION_STATS: (organisationId: string) => `/risks/organisation/${organisationId}/stats`,
    ORGANISATION_EXPORT: (organisationId: string) => `/risks/organisation/${organisationId}/export`,
  },
  ...
  RULES: {
    ...
    VERSIONS: (uuid: string) => `/rules/${uuid}/versions`,
    RESTORE: (uuid: string, versionNumber: number) => `/rules/${uuid}/restore/${versionNumber}`,
    ORGANISATION_STATS: (organisationId: string) => `/rules/stats/organisation/${organisationId}`,
    TEST_DEFINITION: '/rules/test-rule',
